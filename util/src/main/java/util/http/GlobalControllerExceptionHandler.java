...
public class GlobalControllerExceptionHandler {
    ...
    public @ResponseBody HttpErrorInfo handleNotFoundExceptions(ServerHttpRequest request, NotFoundException ex){
        return creaHttpErrorInfo(NOT_FOUND, request, ex);
    }
    ...
    public @ResponseBody HttpErrorInfo handleInvalidInputExceptions(ServerHttpRequest request, InvalidInputException ex){
        return creaHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
    
    private HttpErrorInfo creaHttpErrorInfo(HttpStatus status,ServerHttpRequest request, Exception ex){
